  ...
  <div class="flex min-h-full flex-col sm:mt-8 lg:mt-16">
    ...
    <div class="mx-auto w-full max-w-7xl grow lg:flex xl:px-2">
      ...
      <div class="flex-1 xl:flex">
        <div class="bg-blue-400 border-b border-gray-200 px-4 py-4 sm:px-6 lg:pl-8 xl:w-72 xl:shrink-0 xl:border-b-0 xl:border-r xl:pl-6">
          <!-- Left column area -->
          <ProductSidebar></ProductSidebar>
        </div>

        <div class="bg-blue-300 px-4 py-4 sm:px-6 lg:pl-8 xl:flex-1 xl:pl-6">
          <!-- Main area -->
